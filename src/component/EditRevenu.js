...
export default class EditRevenu extends Component {
    ...
    convertDate=(inputFormat)=> {
     ...
     componentDidMount(){
        axios.get('http://localhost:4000/revenu/edit/'+this.props.match.params.id)
            .then(response => {
                this.setState({ 
    ...
    handleSubmit= (e) =>{
      ...
      axios.post('http://localhost:4000/revenu/update/'+this.props.match.params.id, obj)
          .then(res => {
          console.log(res.data);
          window.location.reload();
          })
      
      this.props.history.push('/DisplayRevenu');
  }
