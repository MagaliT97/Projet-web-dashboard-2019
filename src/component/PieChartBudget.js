          ...
          <Card bg="Secondary" style={{ width: '23rem'}}>
            <Card.Body>
              ...
              <Pie
               ...
               <Card.Text>
                  Revenue: <span className="data-user"> {this.DetectRevenuUndefined(this.props.montantRevenu)} 
                  {displayRevenu}</span> <br/>
                  Budget prévissionnel: <span className="data-user">{this.DetectBudgetUndefined(this.props.montantBudget)}
                  {displayBudget}</span> <br/>
                  Solde prévissionnel: <span className="data-user">{this.solde(this.props.montantRevenu,this.props.montantBudget)}</span><br/> 
              </Card.Text>
            </Card.Body>
          </Card>
